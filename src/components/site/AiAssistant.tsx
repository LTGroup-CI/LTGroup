...
export function AiAssistant() {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: "assistant",
      content:
        "Bonjour, je suis Raï, l'assistante virtuelle de LT GROUP. Avant de répondre à votre demande, j’ai besoin de votre nom et prénoms, puis de votre e-mail et de votre numéro de contact. Nous procéderons étape par étape.",
    },
  ]);
  ...
  useEffect(() => {
    ...
    const storedSession = window.sessionStorage.getItem("ltgroup_ai_session_key") || crypto.randomUUID();
    window.sessionStorage.setItem("ltgroup_ai_session_key", storedSession);
